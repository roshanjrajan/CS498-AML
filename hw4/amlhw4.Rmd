...
#plot(physical$Fore+physical$Bicep+physical$Chest+physical$Neck+physical$Shoulder+physical$Waist+physical$Height+physical$Calf+physical$Thigh+physical$Head, physical$Mass)
#x = seq(650, 800, by=1)
#y = (fit2$coef[1]+fit2$coef[2]+fit2$coef[3]+fit2$coef[4]+fit2$coef[5]+fit2$coef[6]+fit2$coef[7]+fit2$coef[8]+fit2$coef[9]+fit2$coef[10])*x
#curve(x, add=TRUE)
