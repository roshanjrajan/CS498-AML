---
title: "AML hw4"
author: "Kirsten Wong, Kenneth Zhang, Roshan Rajan"
date: "March 6, 2017"
...
plot(log(brunhild$Hours), log(brunhild$Sulfate), main = "Cool", xlab="Thing",ylab="Some")
abline(loglogfit$coefficients)

#b
fit = lm(brunhild$Sulfate ~ brunhild$Hours)
plot(brunhild$Hours, brunhild$Sulfate, main = "Cool", xlab="Thing",ylab="Some")
